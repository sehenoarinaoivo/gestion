...
/*$codecl=mysqli_fetch_array(mysqli_query("select codecl from classe where nom='$nomcl' and promotion='$promo'"));
...
$donnee=mysqli_fetch_array(mysqli_query("select date_dev,coeficient,n_devoir from devoir where numdev='$numdev'"));//  pour afficher les information du devoir k'il a choisis pour ajouter un devoir
