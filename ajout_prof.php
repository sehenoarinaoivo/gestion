...
$pseudo=$_POST['pseudo'];
$passe=$_POST['passe'];
$compte=mysqli_fetch_array(mysqli_query("select count(*) as nb from prof where nom='$nom' and prenom='$prenom'"));// pour ne pas ajouter deux profs similaires
if($compte['nb']>0){
?>
...
$numprof=mysqli_fetch_array(mysqli_query("select numprof from prof where nom='$nom' and prenom='$prenom'"));
$num=$numprof['numprof'];
mysqli_query("insert into login(Num,pseudo,passe,type) values('$num','$pseudo','$passe','prof')");
