...
<div id="monmenu" >
		<ul class="niveau1">
			<li><a href="#" class="fly">Etudiants </a>
...
<?php 
if(!(isset($_SESSION['admin'])) and !isset($_SESSION['prof']) and !isset($_SESSION['etudiant'])){
?>
<form action="index.php" method="post">
<!-- <FIELDSET> -->
<!-- <LEGEND >Authentification<LEGEND>  -->
<label class="label-form" for="">Pseudo:</label><input required placeholder="pseudo" type="text" name="pseudo" size="15">
<label class="label-form" for="">Mot de passe:</label><input required placeholder="mot de passe" type="password" name="mdp" size="15">
<center><input class=" connect-btn" type="submit" value="conecte"></center><br/>
</pre>
<!-- </fieldset> -->
</form>
<?php
...
echo '<br/><br/><br/><li><a class="btn btn-primary" href="index.php?sortir=1">Deconexion</a></li>';
?>
</div>
